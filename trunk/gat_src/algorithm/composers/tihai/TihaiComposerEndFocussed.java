...
public class TihaiComposerEndFocussed extends ComposerStandard implements Composer {
	...
	public TihaiComposerEndFocussed(BolBase bolBase, Tal tal, Variation variation) throws Exception {
		this(bolBase,tal,variation, null);
	}
	
	public TihaiComposerEndFocussed(BolBase bolBase, Tal tal, Variation variation, ThreadGroup threadGroup) throws Exception {
