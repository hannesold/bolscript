...
public class RemoveAndDeleteDialog extends JDialog implements PropertyChangeListener{
	private EditorFrame editor;
	public static final Object[] options = new Object[] {"Delete", "Only remove", "Cancel"};
	public static final int DELETE = 0;
	public static final int ONLY_REMOVE = 1;
	public static final int CANCEL = 2;
	
	private JOptionPane optionPane;
	
	public RemoveAndDeleteDialog (BrowserFrame browser) {
		super(browser);
		this.setModal(true);
		optionPane = new JOptionPane("<html><span style=\"font-size:105%; font-weight:bold\">Do you want to delete the files afterwards?</span><br />" +
				"You are removing the selected compositions from the database.",
